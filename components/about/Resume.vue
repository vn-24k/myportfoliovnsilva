              ...
              <div class="experience-list">
                <div class="resume-item wow fadeInUp delay-0-3s">
                  ...
                  <div class="content">
                    ...
                    <span class="company">Tech Lab Solutions</span>
                  </div>
                </div>
                <div class="resume-item wow fadeInUp delay-0-3s">
                ...
                <div class="resume-item wow fadeInUp delay-0-3s">
                  ...
                  <div class="content">
                    ...
                    <h4>Engenheiro de Software Fullstack</h4>
                    <span class="company">DevPulse Digital</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="single-resume">
              ...
              <div class="experience-list">
                <div class="resume-item wow fadeInUp delay-0-3s">
                  ...
                  <div class="content">
                    <span class="years">2025 - 2028</span>
                    <h4>Engenharia de Software</h4>
                    <span class="company">Universidade Tecnológica</span>
                  </div>
                </div>
                <div class="resume-item wow fadeInUp delay-0-3s">
                  ...
                  <div class="content">
                    ...
                    <h4>IA & Ciência de Dados</h4>
                    <span class="company">Advanced Data Institute</span>
                  </div>
                </div>
                <div class="resume-item wow fadeInUp delay-0-3s">
                  <div class="icon"><i class="ri-terminal-line"></i></div>
                  <div class="content">
                    <span class="years">2024 - 2025</span>
                    <h4>Arquitetura de Sistemas</h4>
                    <span class="company">Tech Academy</span>
                  </div>
                </div>
              </div>
            </div>
