...
.section-title { font-size: 20px; color: #fff; margin-bottom: 30px; font-weight: 600; text-align: center; }

/* Wrapper que centraliza o scroller inteiro */
.scroller-wrapper {
  display: flex;
...
.scroller__inner {
  ...
  /* Centraliza o ponto de início da animação */
  margin: 0 auto;
}
