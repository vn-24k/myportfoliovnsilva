...
/* ESTILO FORÇADO PARA A FOTO DE PERFIL */
.profile-img {
  ...
  box-shadow: 0 0 15px rgba(180, 180, 180, 0.5), 0 0 30px rgba(180, 180, 180, 0.2) !important;
  transition: all 0.4s ease !important;
}

.profile-img:hover {
  transform: scale(1.03) !important;
  box-shadow: 0 0 20px rgba(220, 220, 220, 0.8), 0 0 40px rgba(220, 220, 220, 0.4) !important;
