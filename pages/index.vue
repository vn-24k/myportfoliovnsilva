...
.skill-item-wrapper { padding: 10px; width: 50%; } /* Garante tamanhos iguais */
.skill-item { 
  background: #1a1d21; border-radius: 15px; padding: 25px; /* Quadrado maior */
  text-align: center; border: 2px solid #2d3436; transition: 0.3s;
  min-height: 140px; /* Garante altura mínima igual para todos */
  display: flex; flex-direction: column; align-items: center; justify-content: center;
}
.skill-icon img { max-width: 50px; margin-bottom: 15px; } /* Ícone maior */
