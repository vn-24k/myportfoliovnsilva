...
.skill-item-wrapper { padding: 8px; width: 50%; }
.skill-item { background: #1a1d21; border-radius: 12px; padding: 15px; text-align: center; border: 2px solid #2d3436; transition: 0.3s; }
.skill-icon img { max-width: 40px; margin-bottom: 8px; }
h5 { color: #fff; font-size: 14px; margin: 0; }
.glow-yellow:hover { border-color: #ffdf5e; box-shadow: 0 0 10px #ffdf5e; }
.glow-orange:hover { border-color: #ff9900; box-shadow: 0 0 10px #ff9900; }
.glow-blue:hover { border-color: #2496ed; box-shadow: 0 0 10px #2496ed; }
.glow-white:hover { border-color: #ffffff; box-shadow: 0 0 10px #ffffff; }
.glow-green:hover { border-color: #68a063; box-shadow: 0 0 10px #68a063; }
.glow-cyan:hover { border-color: #61dafb; box-shadow: 0 0 10px #61dafb; }
.glow-lightblue:hover { border-color: #38bdf8; box-shadow: 0 0 10px #38bdf8; }
.glow-brightgreen:hover { border-color: #3ecf8e; box-shadow: 0 0 10px #3ecf8e; }
</style>
